...
import {Avatar, SearchField, Tabs} from "@heroui/react";
...
function mapUserForList(user: User, onlineUsers: string[]): MappedUser {
  const userId = user._id ?? user.id ?? "";
  const fullName = user.fullName ?? user.name ?? "";
  const avatar = user.profilePic ?? user.image ?? "";
